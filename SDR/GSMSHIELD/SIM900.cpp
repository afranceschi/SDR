  ...
  */
  ...
  //if(_tf.find("+CMGL: "))
  {
	...
	*/
	...
	#endif
	#ifdef MEGA
		Serial2.getString("\",\"", "\"", number, nlength);
	#endif
	#ifdef UNO
		_tf.getString("\n", "\nOK", msg, msglength);
	#endif
...
int SIMCOM900::getCCI(char *cci)
{
  ...
  #endif
  #ifdef MEGA
	Serial2.getString("AT+QCCID\r\r\r\n","\r\n",cci, 21);
  #endif
...
char GSM::ComparePhoneNumber(byte position, char *phone_number)
{
  ...
  SerialUSB.print("CHIAMANTE ");
  SerialUSB.println(phone_number);
  SerialUSB.print("SALVATO ");
  SerialUSB.println(sim_phone_number);
