...
class SMSGSM
{
    ...
    void GetHora(char *hora,char *minutos, char *segundos);
    uint32 GetHora();
    void GetFecha(char *dia,char *mes, char *ano);
    uint32 GetFecha();
    void SetHora(char *hora,char *minutos);
    void SetFecha(char *dia,char *mes,char *ano);
    void ConfigHora();
};
